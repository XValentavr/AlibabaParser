...
class AmazonRainforestAPI:
    ...
    def __make_request(self) -> dict:
        """
        Make request to reainforest API
    ...
    def __get_params(product: str, domain: str = None) -> dict:
        ...
        :param product: product id to get info
    ...
    def get_product_full_info(self) -> UUID:
        ...
        :return: extracted data from response that we need
        """
    ...
    def test_json(self):
        return {
            ...
            "product": {
                ...
                "search_alias": {"title": "Electronics", "value": "electronics"},
                ...
                "amazons_choice": {"keywords": "in Micro SD Memory Cards by SanDisk"},
                "rating": 4.7,
                "rating_breakdown": {
                    "five_star": {"percentage": 84, "count": 181617},
                    "four_star": {"percentage": 10, "count": 21621},
                    "three_star": {"percentage": 3, "count": 6486},
                    "two_star": {"percentage": 1, "count": 2162},
                    "one_star": {"percentage": 2, "count": 4324},
                },
                ...
                "attributes": [
                    ...
                    {"name": "Compatible Devices", "value": "Tablet, Smartphone"},
                ],
                "top_reviews": [
                    {
                        "id": "R3F00K7CS1RMKT",
                ...
                "buybox_winner": {
                    "maximum_order_quantity": {"value": 100, "hard_maximum": True},
                ...
                "specifications": [
                    ...
                    {"name": "Memory Speed", "value": "‎100 Megabytes Per Second"},
                    {"name": "Brand", "value": "‎SanDisk"},
                    {
                        "name": "Series",
                        "value": "‎SanDisk Ultra 128GB microSDXC UHS-I card with Adapter - SDSQUAR-128G-GN6MA",
                    },
                    {"name": "Item model number", "value": "‎SDSQUAR-128G-GN6MA"},
                    {"name": "Item Weight", "value": "‎0.16 ounces"},
                    {
                    ...
                    {"name": "Color", "value": "‎Grey,Red, Grey"},
                    {"name": "Department", "value": "‎Memory"},
                    {
                        "name": "Manufacturer",
                        "value": "‎Western Digital Technologies Inc.",
                    },
                    {"name": "ASIN", "value": "‎B073JYC4XM"},
                    {"name": "Is Discontinued By Manufacturer", "value": "‎No"},
                    {"name": "Date First Available", "value": "‎August 3, 2017"},
                    {
            ...
            "newer_model": {
                ...
                "price": {"raw": "$13.99Only 2 left in stock - order soon."},
            },
